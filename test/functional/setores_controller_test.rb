...
class SetoresControllerTest < ActionController::TestCase
  ...
  test "should create setor" do
    assert_difference('Setor.count') do
      post :create, setor: { codigo: @setor.codigo, nome: @setor.nome, sala: @setor.sala, sigla: @setor.sigla }
    end
  ...
  test "should update setor" do
    put :update, id: @setor, setor: { codigo: @setor.codigo, nome: @setor.nome, sala: @setor.sala, sigla: @setor.sigla }
    assert_redirected_to setor_path(assigns(:setor))
  end
