...
class UnidadesControllerTest < ActionController::TestCase
  ...
  test "should create unidade" do
    assert_difference('Unidade.count') do
      post :create, unidade: { cnpj: @unidade.cnpj, fone: @unidade.fone, nome: @unidade.nome, ramal: @unidade.ramal, sigla: @unidade.sigla }
    end
  ...
  test "should update unidade" do
    put :update, id: @unidade, unidade: { cnpj: @unidade.cnpj, fone: @unidade.fone, nome: @unidade.nome, ramal: @unidade.ramal, sigla: @unidade.sigla }
    assert_redirected_to unidade_path(assigns(:unidade))
  end
