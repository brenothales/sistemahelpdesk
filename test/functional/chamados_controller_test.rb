...
class ChamadosControllerTest < ActionController::TestCase
  ...
  test "should create chamado" do
    assert_difference('Chamado.count') do
      post :create, chamado: { assunto: @chamado.assunto, cortesia: @chamado.cortesia, descricao: @chamado.descricao, finalizaSolicitacao: @chamado.finalizaSolicitacao, observacao: @chamado.observacao, prioridade: @chamado.prioridade, solucionado: @chamado.solucionado, tipoAtendimento: @chamado.tipoAtendimento, valorGeral: @chamado.valorGeral }
    end
  ...
  test "should update chamado" do
    put :update, id: @chamado, chamado: { assunto: @chamado.assunto, cortesia: @chamado.cortesia, descricao: @chamado.descricao, finalizaSolicitacao: @chamado.finalizaSolicitacao, observacao: @chamado.observacao, prioridade: @chamado.prioridade, solucionado: @chamado.solucionado, tipoAtendimento: @chamado.tipoAtendimento, valorGeral: @chamado.valorGeral }
    assert_redirected_to chamado_path(assigns(:chamado))
  end
