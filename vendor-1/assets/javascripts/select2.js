    ...
    AbstractSelect2 = clazz(Object, {
        ...
        prepareOpts: function (opts) {
            ...
            opts = $.extend({}, {
                ...
                formatInputTooShort: function (input, min) { return "Por favor insira " + (min - input.length) + " more characters"; },
                formatLoadMore: function (pageNumber) { return "Carregar mais resultados..."; },
