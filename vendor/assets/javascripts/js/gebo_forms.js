	...
	gebo_multiselect = {
		init: function(){
			...
			$('.multiselect').multiSelect({
				selectableHeader	: '<h4>Selecionar Itens</h4>',
				selectedHeader		: '<h4>Itens Selecionados</h4>'
			});
			...
			$('#searchable-form').multiSelect({
				...
				selectedHeader	 : '<a href="javascript:void(0)" id="sForm_deselect" class="btn">Desmarcar tudo</a>'
			});
